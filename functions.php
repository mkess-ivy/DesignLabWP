<?php
/**
 * designLab functions and definitions.
 *
...
function dl_setup() {
	 ...
	 * If you're building a theme based on designLab, use a find and replace
	 * to change 'dl' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'dl', get_template_directory() . '/languages' );
...
add_action( 'after_setup_theme', 'dl_setup' );
 ...
 */
function dl_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'dl_content_width', 640 );
}
add_action( 'after_setup_theme', 'dl_content_width', 0 );
